...
export type InlineToken =
  ...
  | { kind: "code" | "strong" | "text"; text: string };

export type MarkdownBlock =
  | { content: string; kind: "code"; }
  | { content: string; kind: "heading"; level: 1 | 2 | 3 | 4; }
  | { content: string; kind: "paragraph"; }
  | { content: string; kind: "quote"; }
